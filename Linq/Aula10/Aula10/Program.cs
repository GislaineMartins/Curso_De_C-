...
namespace Aula10 {
    class Program {
        ...
        static void Main(string[] args) {
            ...
            Print("NAMES STARTED WITH 'C' AND ANONYNOUS OBJECT ", r3);
            ...
            Console.WriteLine("Sigle or default test1: " + r8);
            var r9 = products.Where(p => p.Id == 30).SingleOrDefault();
            Console.WriteLine("Sigle or default test2: " + r9);

            var r10 = products.Max(products => products.Price);
            Console.WriteLine("Max price: " + r10);

            var r11 = products.Min(products => products.Price);
